...
if "APPIMAGE" in os.environ or "APPDIR" in os.environ:
    ...
    # translation_utils.py is in: usr/share/jellybeam/utils/translation_utils.py
    # We need to get to: usr/share/locale
    script_dir = os.path.dirname(
        os.path.abspath(__file__)
    )  # usr/share/jellybeam/utils
    app_dir = os.path.dirname(script_dir)  # usr/share/jellybeam
...
# Configure the translation text domain for JellyBeam
gettext.bindtextdomain("JellyBeam", locale_dir)
gettext.textdomain("JellyBeam")
